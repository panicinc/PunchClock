...
- `$ cp PunchClockPunch/Clock_Beta.xcconfig.sample PunchClock/PunchClock_Beta.xcconfig`
- `$ cp PunchClockPunch/Clock_Debug.xcconfig.sample PunchClock/PunchClock_Debug.xcconfig`
- `$ pod install`
