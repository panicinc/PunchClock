...
- (void)setText:(NSString *)text
{
	if ([text isEqualToString:@"In"]) {
		super.text = NSLocalizedString(@"In", @"Label used to indicate that a person is in the office");
		...
		super.text = NSLocalizedString(@"Out", @"Label used to indicate that a person is out of the office");
		...
		super.text = NSLocalizedString(@"Near", @"Label used to indicate that a person is near the office");
